...
int main()
{
	...
	do
	{
	cout<<"Welcome to my commandline based Matrix function calculator.\n\n";
	cout<<"Enter the function you wish to perform with the matrix\n";
	cout<<"Enter the number associated with the Function you want to perform\n";
	...
	if(mattype==1)
	{
		cout<<"You have chosen a 2*2 matrix\n";
	...
	{
		cout<<"You have chosen a 3*3 matrix\n";
	...
	{
	cout<<"You have chosen MULTIPLICATION BY A CONSTANT FUNCTION\n";
	cout<<"Enter the Matrix type\n";
	cout<<"1 for 2*2 matrix\n" <<"2 for 3*3 matrix\n";
	cin>> mattype;
	...
	{
	cout<<"You have chosen MULTIPLICATION OF TWO MATRIX FUNCTION\n";
	cout<<"Enter Matrix type\n";
	cout<<"1 for 2*2 matrix\n" <<"2 for 3*3 matrix\n";
	cin>>mattype;
	...
	cout<<"Are you finding the inverse of a 2*2 Matrix(1 for Yes/2 for No)\n";
	cin>>mattypes;
	...
	cout<<"Would you like to run another function 1 for yes and 2 for no";
	cin>>ans;
}
while(ans== 1);
